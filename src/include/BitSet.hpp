// Implements arbitrary bitsets.
// Source: https://github.com/stoianmihail/Netzwerk/blob/main/src/netzwerk/include/BitSet.hpp
...
struct BitSet {
  ...
  // `set2` represents the upper half of the bits.
...
public:
  ...
  bool operator==(uint64_t o) const { return set == o; }
